    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nation', models.BooleanField(verbose_name='居住国家', default=0)),
                ('province', models.SmallIntegerField(verbose_name='居住省', default=0)),
                ('city', models.SmallIntegerField(verbose_name='居住市', default=0)),
                ('signature', models.TextField(verbose_name='个性签名')),
                ('intruduction', models.TextField(verbose_name='个性介绍')),
                ('phone', models.CharField(verbose_name='手机号码', max_length=30, null=True)),
